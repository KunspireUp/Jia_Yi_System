...
<body>
	<div class="login">
		...
		<div class="right">
			<div class="text1">
				<h1 class="h3">添加学生成绩</h1>
			</div>
			<div class="show1">
				<form action="<%=request.getContextPath()%>/InsertStudentServlet" method="post" onsubmit="return check()">
					<span>学号</span><input class="button1" id="st_sno" type="text" value="" name="st_sno"
					onkeyup="value=value.replace(/[^\d]/g,'') "
       				onblur="value=value.replace(/[^\d]/g,'')"
       				ng-model="schedule.round"
       				placeholder="请输入数字">
					<span>姓名</span><input class="button1" id="st_name" type="text" value="" name="st_name" 
					onkeyup="value=value.replace(/[^\u4e00-\u9fa5]/g,'')"
					onblur="value=value.replace(/[^\u4e00-\u9fa5]/g,'')"
					placeholder="请输入中文">
					<span>班级</span><input class="button1" id="st_classz" type="text" value="" name="st_classz"
					placeholder="请输入中文">
					<span>语文</span><input class="button1" id="st_chinese" type="text" value="" name="st_chinese"
					onkeyup="value=value.replace(/[^\d]/g,'') "      
       				onblur="value=value.replace(/[^\d]/g,'')" 
       				ng-model="schedule.round"
       				placeholder="请输入数字">
					<span>英语</span><input class="button1" id="st_math" type="text" value="" name="st_math"
					onkeyup="value=value.replace(/[^\d]/g,'') "      
       				onblur="value=value.replace(/[^\d]/g,'')" 
       				ng-model="schedule.round"
       				placeholder="请输入数字">
					<span>数学</span><input class="button1" id="st_english" type="text" value="" name="st_english"
					onkeyup="value=value.replace(/[^\d]/g,'') "      
       				onblur="value=value.replace(/[^\d]/g,'')" 
       				ng-model="schedule.round"
       				placeholder="请输入数字">
					<span>物理</span><input class="button1" id="st_physics" type="text" value="" name="st_physics"
					onkeyup="value=value.replace(/[^\d]/g,'') "      
       				onblur="value=value.replace(/[^\d]/g,'')" 
       				ng-model="schedule.round"
       				placeholder="请输入数字">
					<span>化学</span><input class="button1" id="st_chemistry" type="text" value="" name="st_chemistry"
					onkeyup="value=value.replace(/[^\d]/g,'') "      
       				onblur="value=value.replace(/[^\d]/g,'')" 
       				ng-model="schedule.round"
       				placeholder="请输入数字">
