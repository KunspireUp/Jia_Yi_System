...
<div class="login">
    ...
    <div class="right">
        <div class="text1">
            <h1 class="h3">查询学生信息</h1>
        </div>
        <div class="show1">
            <form action="<%=request.getContextPath()%>/DeleteStudentServlet" method="post">
                <span>学号</span><input name="st_del_sno" class="button1" type="text" readonly="readonly"
                                        value="<%=session.getAttribute("st_sno") %>">
                <span>姓名</span><input class="button1" type="text" readonly="readonly"
                                        value="<%=session.getAttribute("st_name") %>">
                <span>班级</span><input class="button1" type="text" readonly="readonly"
                                        value="<%=session.getAttribute("st_classz") %>">
                <span>语文</span><input class="button1" type="text" readonly="readonly"
                                        value="<%=session.getAttribute("st_chinese") %>">
                <span>英语</span><input class="button1" type="text" readonly="readonly"
                                        value="<%=session.getAttribute("st_math") %>">
                <span>数学</span><input class="button1" type="text" readonly="readonly"
                                        value="<%=session.getAttribute("st_english") %>">
                <span>物理</span><input class="button1" type="text" readonly="readonly"
                                        value="<%=session.getAttribute("st_physics") %>">
                <span>化学</span><input class="button1" type="text" readonly="readonly"
                                        value="<%=session.getAttribute("st_chemistry") %>">
                <p class="input_p">
