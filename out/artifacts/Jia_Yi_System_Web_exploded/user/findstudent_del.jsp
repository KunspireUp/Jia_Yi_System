...
<body>
    <div class="login">
        ...
        <div class="right">
            <div class="text1">
                <h1 class="h3">查询需要删除的学生</h1>
            </div>
            <div class="show1">
                <form action="<%=request.getContextPath()%>/FindStudentServlet2" method="post">
                    <input class="button1"
                           name="st_del_sno"
                           type="text"
                           value=""
                           style="padding-left: 40px;"
                           placeholder="请输入删除学生的学号" maxlength="15"
                           onkeyup="value=value.replace(/[^\d]/g,'') "
                           onblur="value=value.replace(/[^\d]/g,'')"
                    >
                <p class="input_p"><input type="submit" value="查询">&nbsp;&nbsp;&nbsp;&nbsp;<input type="button" value="重置" onclick="reset() "></p>
                </form>
