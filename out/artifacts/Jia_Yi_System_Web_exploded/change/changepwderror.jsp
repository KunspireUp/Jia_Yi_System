    ...
    <div class="loginsucess">
        <div class="center">
            <div class="box-1">
                ...
                <p>CHANGE ERROR</p>
                <p>修改 <span>【<%=session.getAttribute("change_user") %> 学生密码修改错误】</span>登录教务系统</p>
                <h3>页面加载中，<span id="second">3</span>秒后跳转修改界面...</h3>
            </div>
        </div>
    </div>
...
%>
    <script>
        ...
        var timer = setInterval(function () {
            ...
            Os.innerText = num;
            if (num == 0) {
                location.href=window.location.origin + "/Jia_Yi_System/user/student.jsp";
            }
        }, 1000)
        function stop() {
            clearInterval(timer);
