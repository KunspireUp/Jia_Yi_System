...
<head>
    ...
    <link href="<c:url value="/css/findpwdshow.css" />" rel="stylesheet"  type="text/css" />
</head>
...
<body>
    <div class="login">
        ...
        <div class="right">
            <div class="text1">
                <h1 class="h3">密码找回成功成功</h1>
            </div>
            <div class="show1">
                <span>学号</span><input class="button1" type="text" readonly="readonly" value="<%=session.getAttribute("find_user")%>">
                <span>密码</span><input class="button1" type="text" readonly="readonly" value="<%=session.getAttribute("getPassword")%>">
            </div>
        </div>
    </div>
    <hr />
