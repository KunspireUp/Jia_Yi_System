		...
		<div class="right">
			...
			<div class="show1">
				<form action="<%=request.getContextPath()%>/ChnageStudentInfoServlet" method="post" onsubmit="return check()">
					<span>学号</span><input class="button1" id="st_sno" type="text" value="<%=session.getAttribute("st_sno") %>" name="st_sno" readonly unselectable="on">
					<span>姓名</span><input class="button1" id="st_name" type="text" value="<%=session.getAttribute("st_name") %>" name="st_name" 
